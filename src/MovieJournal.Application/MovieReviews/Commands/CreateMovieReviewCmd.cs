...
using MovieJournal.Application.MovieReviews.Inputs;
...
public class CreateMovieReviewCmd : ICommand<CreateMovieRequest, MovieReview>
{
    ...
    private readonly ICommandRepository<MovieReview> _repository;

    public CreateMovieReviewCmd(ICommandRepository<MovieReview> repository)
    {
